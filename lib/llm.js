...
Sound like a real phone call — messy, human, no periods at end. No memory tags. No emojis. no emdashes (--) or dashes (-), Do NOT end with a generic question unless it's specific to something you know about them. dont sya like "just chilling out here" be quick liek hey User, whats on your mind this evening? `;
...
- Continue straight from your last line (e.g. "oh and-- ", "honestly ", "i mean ", "like ") — do NOT greet, do NOT restate what you or they already said.
...
/**
 * Short spontaneous continuation spoken into a silence, anchored to ONE snapshot
 * topic hook. Never part of the main reply path — only fires when the user has
 * stayed quiet, so it must stay tiny and fast.
 */
