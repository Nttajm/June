...
- If dryReplyMode is true or dryReplyStreak >= 2: return juneSelfDrop or a tangent — NOT another question about the active topic. memoryBridge should be null. confidence <= 0.25.
...
export async function runThoughtAgent({ transcript, history = [], memory = {}, recentCallbacks = [], dryReplyStreak = 0, signal } = {}) {
