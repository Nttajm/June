...
export const config = {
  ...
  memoryAiModel: process.env.MEMORY_AI_MODEL || "gpt-4o-mini",
  thoughtAiModel: process.env.THOUGHT_AI_MODEL || "gpt-4o-mini",
  thoughtDebounceMs: Number(process.env.THOUGHT_DEBOUNCE_MS) || 500,
  thoughtRateLimitMs: Number(process.env.THOUGHT_RATE_LIMIT_MS) || 5000,
  // Snapshot agent (background topic context)
  snapshotAiModel: process.env.SNAPSHOT_AI_MODEL || "gpt-4o-mini",
